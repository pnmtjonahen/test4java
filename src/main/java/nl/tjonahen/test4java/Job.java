...
public class Job {
    ...
    public String send(final JavaDeveloper javaDeveloper, final Contractor contractor) {
        ...
        final Response response = wegTarget.request("application/json").post(Entity.json(javaDeveloper), Response.class);
